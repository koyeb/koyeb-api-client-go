...
// ListInstanceSnapshotEventsReply struct for ListInstanceSnapshotEventsReply
type ListInstanceSnapshotEventsReply struct {
	Events []InstanceSnapshotEvent `json:"events,omitempty"`
...
func NewListInstanceSnapshotEventsReply() *ListInstanceSnapshotEventsReply {
	this := ListInstanceSnapshotEventsReply{}
	return &this
}
...
// SetEvents gets a reference to the given []InstanceSnapshotEvent and assigns it to the Events field.
...
func (o ListInstanceSnapshotEventsReply) MarshalJSON() ([]byte, error) {
...
type NullableListInstanceSnapshotEventsReply struct {
	value *ListInstanceSnapshotEventsReply
	isSet bool
}

func (v NullableListInstanceSnapshotEventsReply) Get() *ListInstanceSnapshotEventsReply {
	return v.value
}

func (v *NullableListInstanceSnapshotEventsReply) Set(val *ListInstanceSnapshotEventsReply) {
	v.value = val
	v.isSet = true
}

func (v NullableListInstanceSnapshotEventsReply) IsSet() bool {
	return v.isSet
}

func (v *NullableListInstanceSnapshotEventsReply) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListInstanceSnapshotEventsReply(val *ListInstanceSnapshotEventsReply) *NullableListInstanceSnapshotEventsReply {
	return &NullableListInstanceSnapshotEventsReply{value: val, isSet: true}
}

func (v NullableListInstanceSnapshotEventsReply) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListInstanceSnapshotEventsReply) UnmarshalJSON(src []byte) error {
	v.isSet = true
