...
type NullableListAppEventsReply struct {
	value *ListAppEventsReply
	isSet bool
}

func (v NullableListAppEventsReply) Get() *ListAppEventsReply {
	return v.value
}

func (v *NullableListAppEventsReply) Set(val *ListAppEventsReply) {
	v.value = val
	v.isSet = true
}
...
func NewNullableListAppEventsReply(val *ListAppEventsReply) *NullableListAppEventsReply {
	return &NullableListAppEventsReply{value: val, isSet: true}
}
