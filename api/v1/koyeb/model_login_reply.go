...
// checks if the LoginReply type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LoginReply{}
...
func (o LoginReply) ToMap() (map[string]interface{}, error) {
