...
type SsoApi interface {
	 ...
	 */
	DiscourseAuth(ctx _context.Context) ApiDiscourseAuthRequest

	/*
	 * DiscourseAuthExecute executes the request
	 * @return DiscourseAuthReply
	 */
	DiscourseAuthExecute(r ApiDiscourseAuthRequest) (DiscourseAuthReply, *_nethttp.Response, error)
}
...
func (r ApiDiscourseAuthRequest) Execute() (DiscourseAuthReply, *_nethttp.Response, error) {
 ...
 * @return ApiDiscourseAuthRequest
 */
func (a *SsoApiService) DiscourseAuth(ctx _context.Context) ApiDiscourseAuthRequest {
	return ApiDiscourseAuthRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return DiscourseAuthReply
 */
func (a *SsoApiService) DiscourseAuthExecute(r ApiDiscourseAuthRequest) (DiscourseAuthReply, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
