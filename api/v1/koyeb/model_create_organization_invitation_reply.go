...
// checks if the CreateOrganizationInvitationReply type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateOrganizationInvitationReply{}
...
func (o CreateOrganizationInvitationReply) ToMap() (map[string]interface{}, error) {
