...
type DeploymentsApi interface {
	 ...
	 */
	CancelDeployment(ctx _context.Context, id string) ApiCancelDeploymentRequest

	/*
	 * CancelDeploymentExecute executes the request
	 * @return interface{}
	 */
	CancelDeploymentExecute(r ApiCancelDeploymentRequest) (interface{}, *_nethttp.Response, error)
...
func (r ApiCancelDeploymentRequest) Execute() (interface{}, *_nethttp.Response, error) {
 ...
 * @return ApiCancelDeploymentRequest
 */
func (a *DeploymentsApiService) CancelDeployment(ctx _context.Context, id string) ApiCancelDeploymentRequest {
	return ApiCancelDeploymentRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
 ...
 * @return interface{}
 */
func (a *DeploymentsApiService) CancelDeploymentExecute(r ApiCancelDeploymentRequest) (interface{}, *_nethttp.Response, error) {
	var (
