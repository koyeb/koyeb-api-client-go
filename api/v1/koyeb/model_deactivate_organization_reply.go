...
// checks if the DeactivateOrganizationReply type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeactivateOrganizationReply{}
...
func (o DeactivateOrganizationReply) ToMap() (map[string]interface{}, error) {
