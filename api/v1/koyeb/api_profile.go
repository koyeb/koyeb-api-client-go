...
type ProfileApi interface {
	...
	*/
	...
	DeleteAccountExecute(r ApiDeleteAccountRequest) (map[string]interface{}, *http.Response, error)
...
func (r ApiDeleteAccountRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
DeleteAccount Method for DeleteAccount
 ...
 @return ApiDeleteAccountRequest
*/
func (a *ProfileApiService) DeleteAccount(ctx context.Context) ApiDeleteAccountRequest {
	return ApiDeleteAccountRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return map[string]interface{}
func (a *ProfileApiService) DeleteAccountExecute(r ApiDeleteAccountRequest) (map[string]interface{}, *http.Response, error) {
	var (
...
func (a *ProfileApiService) OAuthCallbackExecute(r ApiOAuthCallbackRequest) (*OAuthCallbackReply, *http.Response, error) {
	...
	if r.seonFp != nil {
		parameterAddToHeaderOrQuery(localVarHeaderParams, "seon-fp", r.seonFp, "")
	}
	// body params
	localVarPostBody = r.body
	if r.ctx != nil {
...
func (a *ProfileApiService) UpdateUserExecute(r ApiUpdateUserRequest) (*UserReply, *http.Response, error) {
	...
	if r.updateMask != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "update_mask", r.updateMask, "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
