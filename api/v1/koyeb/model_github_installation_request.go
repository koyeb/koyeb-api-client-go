...
// checks if the GithubInstallationRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GithubInstallationRequest{}
...
func (o GithubInstallationRequest) ToMap() (map[string]interface{}, error) {
