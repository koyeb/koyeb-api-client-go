...
type SubscriptionsApi interface {
	 ...
	 */
	GetSubscription(ctx _context.Context, id string) ApiGetSubscriptionRequest

	/*
	 * GetSubscriptionExecute executes the request
	 * @return GetSubscriptionReply
	 */
	GetSubscriptionExecute(r ApiGetSubscriptionRequest) (GetSubscriptionReply, *_nethttp.Response, error)
}
...
func (r ApiGetSubscriptionRequest) Execute() (GetSubscriptionReply, *_nethttp.Response, error) {
 ...
 * @return ApiGetSubscriptionRequest
 */
func (a *SubscriptionsApiService) GetSubscription(ctx _context.Context, id string) ApiGetSubscriptionRequest {
	return ApiGetSubscriptionRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
 ...
 * @return GetSubscriptionReply
 */
func (a *SubscriptionsApiService) GetSubscriptionExecute(r ApiGetSubscriptionRequest) (GetSubscriptionReply, *_nethttp.Response, error) {
	var (
