 ...
 */
func (a *RegionsApiService) GetRegion(ctx _context.Context, id string) ApiGetRegionRequest {
	return ApiGetRegionRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
 ...
 */
func (a *RegionsApiService) GetRegionExecute(r ApiGetRegionRequest) (GetRegionReply, *_nethttp.Response, error) {
	var (
 ...
 */
func (a *RegionsApiService) ListRegions(ctx _context.Context) ApiListRegionsRequest {
	return ApiListRegionsRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *RegionsApiService) ListRegionsExecute(r ApiListRegionsRequest) (ListRegionsReply, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
