...
// checks if the InstanceListItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstanceListItem{}
...
func (o InstanceListItem) ToMap() (map[string]interface{}, error) {
