...
> CreateBudgetReply CreateBudget(ctx, organizationId).Amount(amount).Execute()
...
func main() {
    ...
    amount := "amount_example" // string | In cents. (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.OrganizationApi.CreateBudget(context.Background(), organizationId).Amount(amount).Execute()
    if err != nil {
...
> UpdateBudgetReply UpdateBudget(ctx, organizationId).Amount(amount).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.OrganizationApi.UpdateBudget(context.Background(), organizationId).Amount(amount).Execute()
    if err != nil {
