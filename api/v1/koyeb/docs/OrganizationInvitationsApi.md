...
func main() {
    ...
    resp, r, err := api_client.OrganizationInvitationsApi.CreateOrganizationInvitation(context.Background()).Body(body).Execute()
    if err != nil {
...
> interface{} DeleteOrganizationInvitation(ctx, id).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.OrganizationInvitationsApi.DeleteOrganizationInvitation(context.Background(), id).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.OrganizationInvitationsApi.ListOrganizationInvitations(context.Background()).Limit(limit).Offset(offset).Statuses(statuses).UserId(userId).Execute()
    if err != nil {
...
func main() {
    ...
    body := *openapiclient.NewResendOrganizationInvitationRequest() // ResendOrganizationInvitationRequest | 

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.OrganizationInvitationsApi.ResendOrganizationInvitation(context.Background(), id).Body(body).Execute()
    if err != nil {
 ...
 **body** | [**ResendOrganizationInvitationRequest**](ResendOrganizationInvitationRequest.md) |  | 
