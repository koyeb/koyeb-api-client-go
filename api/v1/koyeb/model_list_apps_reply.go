...
// checks if the ListAppsReply type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListAppsReply{}
...
func (o ListAppsReply) ToMap() (map[string]interface{}, error) {
