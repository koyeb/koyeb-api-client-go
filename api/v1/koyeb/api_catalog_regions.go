...
func (r ApiGetRegionRequest) Execute() (*GetRegionReply, *http.Response, error) {
...
GetRegion Get Region
 ...
 @return ApiGetRegionRequest
*/
func (a *CatalogRegionsApiService) GetRegion(ctx context.Context, id string) ApiGetRegionRequest {
	return ApiGetRegionRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
//  @return GetRegionReply
func (a *CatalogRegionsApiService) GetRegionExecute(r ApiGetRegionRequest) (*GetRegionReply, *http.Response, error) {
	var (
...
func (r ApiListRegionsRequest) Execute() (*ListRegionsReply, *http.Response, error) {
...
ListRegions List Region
 ...
 @return ApiListRegionsRequest
*/
func (a *CatalogRegionsApiService) ListRegions(ctx context.Context) ApiListRegionsRequest {
	return ApiListRegionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListRegionsReply
func (a *CatalogRegionsApiService) ListRegionsExecute(r ApiListRegionsRequest) (*ListRegionsReply, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
