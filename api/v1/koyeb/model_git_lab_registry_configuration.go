...
// checks if the GitLabRegistryConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GitLabRegistryConfiguration{}
...
func (o GitLabRegistryConfiguration) ToMap() (map[string]interface{}, error) {
