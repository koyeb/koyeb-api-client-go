...
// checks if the KsearchService type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KsearchService{}
...
func (o KsearchService) ToMap() (map[string]interface{}, error) {
