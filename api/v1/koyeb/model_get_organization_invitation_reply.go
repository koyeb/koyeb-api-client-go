...
// checks if the GetOrganizationInvitationReply type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetOrganizationInvitationReply{}
...
func (o GetOrganizationInvitationReply) ToMap() (map[string]interface{}, error) {
