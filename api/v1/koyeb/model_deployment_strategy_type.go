...
// DeploymentStrategyType  - DEPLOYMENT_STRATEGY_TYPE_INVALID: DEPRECATED: Use DEPLOYMENT_STRATEGY_TYPE_DEFAULT instead.  - DEPLOYMENT_STRATEGY_TYPE_DEFAULT: Default/unspecified strategy (resolves to platform default, currently ROLLING).  - DEPLOYMENT_STRATEGY_TYPE_CANARY: Use canary strategy.  - DEPLOYMENT_STRATEGY_TYPE_ROLLING: Use rolling strategy.  - DEPLOYMENT_STRATEGY_TYPE_BLUE_GREEN: Use blue green strategy.  - DEPLOYMENT_STRATEGY_TYPE_IMMEDIATE: Use immediate strategy.
...
const (
	...
	DEPLOYMENTSTRATEGYTYPE_DEFAULT DeploymentStrategyType = "DEPLOYMENT_STRATEGY_TYPE_DEFAULT"
