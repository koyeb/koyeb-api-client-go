...
// checks if the ManageReply type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ManageReply{}
...
func (o ManageReply) ToMap() (map[string]interface{}, error) {
