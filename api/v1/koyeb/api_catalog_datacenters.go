...
func (r ApiListDatacentersRequest) Execute() (*ListDatacentersReply, *http.Response, error) {
...
ListDatacenters List datacenters
 ...
 @return ApiListDatacentersRequest
*/
func (a *CatalogDatacentersApiService) ListDatacenters(ctx context.Context) ApiListDatacentersRequest {
	return ApiListDatacentersRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return ListDatacentersReply
func (a *CatalogDatacentersApiService) ListDatacentersExecute(r ApiListDatacentersRequest) (*ListDatacentersReply, *http.Response, error) {
	var (
