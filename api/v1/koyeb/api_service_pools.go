...
type ServicePoolsApi interface {
	...
	*/
	...
	/*
	DeleteServicePool Delete a ServicePool

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id
	@return ApiDeleteServicePoolRequest
	*/
	DeleteServicePool(ctx context.Context, id string) ApiDeleteServicePoolRequest

	// DeleteServicePoolExecute executes the request
	//  @return map[string]interface{}
	DeleteServicePoolExecute(r ApiDeleteServicePoolRequest) (map[string]interface{}, *http.Response, error)
	...
	*/
	...
	/*
	UpdateServicePool Method for UpdateServicePool

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id
	@return ApiUpdateServicePoolRequest
	*/
	UpdateServicePool(ctx context.Context, id string) ApiUpdateServicePoolRequest

	// UpdateServicePoolExecute executes the request
	//  @return UpdateServicePoolReply
	UpdateServicePoolExecute(r ApiUpdateServicePoolRequest) (*UpdateServicePoolReply, *http.Response, error)
}
...
type ApiDeleteServicePoolRequest struct {
	ctx context.Context
	ApiService ServicePoolsApi
	id string
}

func (r ApiDeleteServicePoolRequest) Execute() (map[string]interface{}, *http.Response, error) {
	return r.ApiService.DeleteServicePoolExecute(r)
}
...
DeleteServicePool Delete a ServicePool
 ...
 @return ApiDeleteServicePoolRequest
*/
func (a *ServicePoolsApiService) DeleteServicePool(ctx context.Context, id string) ApiDeleteServicePoolRequest {
	return ApiDeleteServicePoolRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *ServicePoolsApiService) DeleteServicePoolExecute(r ApiDeleteServicePoolRequest) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServicePoolsApiService.DeleteServicePool")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiUpdateServicePoolRequest struct {
	ctx context.Context
	ApiService ServicePoolsApi
	id string
	servicePool *UpdateServicePool
	updateMask *string
}

func (r ApiUpdateServicePoolRequest) ServicePool(servicePool UpdateServicePool) ApiUpdateServicePoolRequest {
	r.servicePool = &servicePool
	return r
}

func (r ApiUpdateServicePoolRequest) UpdateMask(updateMask string) ApiUpdateServicePoolRequest {
	r.updateMask = &updateMask
	return r
}

func (r ApiUpdateServicePoolRequest) Execute() (*UpdateServicePoolReply, *http.Response, error) {
	return r.ApiService.UpdateServicePoolExecute(r)
}
...
UpdateServicePool Method for UpdateServicePool
 ...
 @return ApiUpdateServicePoolRequest
*/
func (a *ServicePoolsApiService) UpdateServicePool(ctx context.Context, id string) ApiUpdateServicePoolRequest {
	return ApiUpdateServicePoolRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return UpdateServicePoolReply
func (a *ServicePoolsApiService) UpdateServicePoolExecute(r ApiUpdateServicePoolRequest) (*UpdateServicePoolReply, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *UpdateServicePoolReply
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServicePoolsApiService.UpdateServicePool")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
