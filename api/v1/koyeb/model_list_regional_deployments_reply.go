...
// checks if the ListRegionalDeploymentsReply type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListRegionalDeploymentsReply{}
...
func (o ListRegionalDeploymentsReply) ToMap() (map[string]interface{}, error) {
