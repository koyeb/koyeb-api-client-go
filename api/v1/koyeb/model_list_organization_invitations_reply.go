...
type ListOrganizationInvitationsReply struct {
	OrganizationInvitations *[]OrganizationInvitation `json:"organization_invitations,omitempty"`
...
// GetOrganizationInvitations returns the OrganizationInvitations field value if set, zero value otherwise.
func (o *ListOrganizationInvitationsReply) GetOrganizationInvitations() []OrganizationInvitation {
	if o == nil || o.OrganizationInvitations == nil {
...
// GetOrganizationInvitationsOk returns a tuple with the OrganizationInvitations field value if set, nil otherwise
...
// SetOrganizationInvitations gets a reference to the given []OrganizationInvitation and assigns it to the OrganizationInvitations field.
...
func (o ListOrganizationInvitationsReply) MarshalJSON() ([]byte, error) {
	...
	if o.OrganizationInvitations != nil {
