...
func (r ApiGetOrganizationSummaryRequest) Execute() (*GetOrganizationSummaryReply, *http.Response, error) {
...
//  @return GetOrganizationSummaryReply
func (a *SummaryApiService) GetOrganizationSummaryExecute(r ApiGetOrganizationSummaryRequest) (*GetOrganizationSummaryReply, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetOrganizationSummaryReply
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SummaryApiService.GetOrganizationSummary")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/organizations/{organization_id}/summary"
