...
const (
	...
	VERIFYDOCKERIMAGEREPLYERRCODE_INVALID_SCHEME VerifyDockerImageReplyErrCode = "INVALID_SCHEME"
	VERIFYDOCKERIMAGEREPLYERRCODE_GENERIC VerifyDockerImageReplyErrCode = "GENERIC"
)
